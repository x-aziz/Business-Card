  ...
  return (
    <div className="">
      {/* <div className="flex items-center justify-between mb-2 sm:mb-3">
        <h3 className="text-white font-semibold text-[10px] sm:text-xs md:text-sm"></h3>
      ...
      <div className="grid grid-cols-2 gap-1.5 sm:gap-2 md:gap-3">
        <div className="glass rounded p-1.5 sm:p-2 md:p-3">
          <div className="text-base sm:text-xl md:text-2xl font-bold text-cyan-300">
            {views}
          </div>
        ...
        <div className="glass rounded p-1.5 sm:p-2 md:p-3">
          <div className="text-base sm:text-xl md:text-2xl font-bold text-purple-300">
            {projects}+
          </div>
        ...
        <div className="glass rounded p-1.5 sm:p-2 md:p-3">
          <div className="text-base sm:text-xl md:text-2xl font-bold text-green-300">
            {score}/100
          </div>
        ...
        <div className="glass rounded p-1.5 sm:p-2 md:p-3">
          <div className="text-base sm:text-xl md:text-2xl font-bold text-blue-300">
            {experience}+ yrs
          </div>
